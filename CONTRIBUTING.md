...
Think c3dr is useful? Let others discover it, by telling them in person,
via social media or a blog post.

Using c3dr for a paper you are writing? Retrieve all citation
information by running `citation("c3dr")` in the R console.

### Ask a question

Using c3dr and got stuck? Browse the
[documentation](https://docs.ropensci.org/c3dr/) to see if you can find
a solution. Still stuck? Post your question as an [issue on
GitHub](https://github.com/ropensci/c3dr/issues).
...
Have an idea for a new c3dr feature? Take a look at the
[documentation](https://docs.ropensci.org/c3dr/) and [issue
list](https://github.com/ropensci/c3dr/issues) to see if it isn’t
included or suggested yet. If not, suggest your idea as an [issue on
GitHub](https://github.com/ropensci/c3dr/issues). While we can’t promise
...
Using c3dr and discovered a bug? That’s annoying! Don’t let others have
the same experience and report it as an [issue on
GitHub](https://github.com/ropensci/c3dr/issues) so we can fix it. A
...
[This website](https://docs.ropensci.org/c3dr/) is generated with
...
issue](https://github.com/ropensci/c3dr/issues) and we can point you in
the right direction.
...
1.  Go to `R/` directory in the [code
    repository](https://github.com/ropensci/c3dr).
...
Care to fix bugs or implement new functionality for c3dr? Awesome! Have
a look at the [issue list](https://github.com/ropensci/c3dr/issues) and
...
1.  Fork [this repo](https://github.com/ropensci/c3dr) and clone it to
